...
export function getRegistryAccessData(name, npmrc) {
  ...
  // Handle case where npmrc is undefined or null
  if (!npmrc) {
    npmrc = {
      defaultRegistry: 'https://registry.npmjs.org/',
      envRegistry: 'https://registry.npmjs.org/',
      authTokens: [],
      scopes: {},
    };
  }
